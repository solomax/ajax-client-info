...
public class BrowserInfoForm extends Panel
{
	...
	private final Form<ClientPropertiesBean> form;
	...
	public BrowserInfoForm(String id)
	{
		...
		form = new Form<ClientPropertiesBean>("postback",
	...
	protected Form<ClientPropertiesBean> getForm() {
		return form;
	}
	...
	public void renderHead(IHeaderResponse response) {
		...
		response.render(JavaScriptHeaderItem.forReference(new JavaScriptResourceReference(BrowserInfoForm.class, "submit-client-info.js")));
	}
